  ...
  return (
    <div className="max-w-3xl mx-auto px-5 py-10 bg-white text-gray-900 font-sans text-[15px] leading-relaxed pt-15 border-t border-white/2">
      ...
      <p className="text-gray-800 mb-6">
        This Face Yoga course is designed to help you naturally tone,
        lift, and rejuvenate your facial muscles. Learn effective
        exercises, techniques, and holistic practices to enhance your
        beauty and inner well-being.
      </p>
