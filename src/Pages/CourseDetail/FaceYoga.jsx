...
function FaceYoga() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 text-center pt-15 border-t border-white/2">
      ...
      {/* ── Text ── */}
      <p className="text-xs uppercase tracking-[0.4em] text-gray-400 mb-3"> FaceYoga Page Under Construction</p>
      <h1 className="text-4xl sm:text-5xl font-extrabold text-black mb-4"> FaceYoga Page Coming Soon</h1>
