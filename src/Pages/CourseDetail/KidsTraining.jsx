  ...
  return (
    <div className="bg-white text-black min-h-screen">
      <section className="bg-black text-white py-20 px-6 text-center">
        <Link
          to="/courses"
          className="text-gray-400 text-sm hover:text-white mb-6 inline-block"
        >
          ← Back to Courses
        </Link>
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <h2 className="text-3xl font-extrabold mb-10 border-b-2 border-black pb-4">
          Course Syllabus
        </h2>
        <div className="space-y-8">
          {syllabus.map((sec, i) => (
            <div
              key={i}
              className="border border-gray-200 rounded-2xl p-7 hover:border-black transition-all"
            >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {inclusions.map((item, i) => (
              <div
                key={i}
                className="border border-gray-700 rounded-xl px-5 py-4 flex items-center gap-3"
              >
