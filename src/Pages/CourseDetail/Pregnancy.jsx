...
const syllabus = [
  { heading: "Prenatal Yoga", items: ["Safe Asanas During Pregnancy", "Trimester-wise Modifications", "Breathing for Labour", "Pelvic Floor Exercises", "Stress Relief Techniques"] },
  { heading: "Postnatal Recovery", items: ["Postnatal Yoga Sequences", "Core Rebuilding", "Breastfeeding-friendly Poses", "Baby Yoga Bonding", "Hormonal Balance Postpartum"] },
  { heading: "Theory & Anatomy", items: ["Reproductive Anatomy", "Physiological Changes in Pregnancy", "Contraindications & Safety", "Teaching Methodology", "Diet & Nutrition in Pregnancy"] },
];
...
export default function Pregnancy() {
  return <CourseLayout title="Pregnancy and Postnatal" badge="Live on Zoom" syllabus={syllabus} inclusions={inclusions} />;
}

// ── Reusable Layout ──────────────────────────────────────────────────────────
function CourseLayout({ title, badge, syllabus, inclusions, extra }) {
  return (
