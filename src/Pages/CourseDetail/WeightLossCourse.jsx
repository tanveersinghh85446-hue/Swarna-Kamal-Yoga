...
const inclusions = ["Live & Recorded Sessions","Study Materials in PDFs","Soft Copy of Certificate","Notes Access Free During Course","Access to Recordings Online"];
export default function WeightLossCourse() {
  return <CourseLayout title="Weight Loss Coach Certification" tags={["June 4th","7:00 PM IST","Live on Zoom"]} syllabus={syllabus} inclusions={inclusions} />;
}