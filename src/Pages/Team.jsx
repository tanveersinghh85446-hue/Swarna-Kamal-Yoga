            ...
            <div className="w-full md:w-2/3 p-8 md:p-10">
              ...
              <div className="mb-6">
                ...
                <ul className="text-gray-700 text-sm space-y-1.5">
                  ...
                  <li>• Certified Yoga Teacher Training from Yoga Alliance (RYT 200)</li>
                  <li>• Certified Yoga Therapist</li>
                  <li>• Certified in Yin Yoga & Face Yoga</li>
                  <li>• Certified in Pre and Postnatal Yoga Teacher Training from Ekam Yoga and Wellness Institute, WYORS</li>
                  <li>• Certified Patanjali Assistant Yoga Teacher by completing the training course from Patanjali Yoga Samiti</li>
                  <li>• Completed and certified in "Sthira Sukham Asanam - Asana , Props and Alignment Specialist" course (50 hrs.) from Yoga Alliance</li>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  body; moving to remember who we are beneath & knowing self
                  awareness & emotional.
                </p>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="text-gray-700 text-sm space-y-1.5">
                  ...
                  <li>• Power and Grace in a steady warrior pose or quiet fold</li>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-2/3 p-8 md:p-10">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  <strong>
                    ...
                    present you can be. My mission is to strip away the
                    complexity and give every student a practice they can truly
                    call their own.
                  </strong>
                </p>
              ...
              <div className="mb-6">
                ...
                <ul className="text-gray-700 text-sm space-y-1.5">
                  <li>• <strong>Menopause & Yoga</strong> – Hormonal transitions addressed through targeted asana and breathwork</li>
                  <li>• <strong>Women's Wellness Circle</strong> – Holistic sessions covering physical, emotional and hormonal well-being</li>
                  <li>• <strong>Foundations Programme</strong> – Structured beginner course building correct form, breath, and discipline</li>
                  <li>• <strong>Root-Based Practice</strong> – Traditional yogacombined with modern anatomical understanding</li>
                </ul>
              </div>
            ...
            <div className="w-full md:w-2/3 p-8 md:p-10">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ...
                  promote holistic well-being and mindfulness. Expertise in
                  Hatha, Vinyasa, Ashtanga Yoga, Strength training, Circuit
                  training and Pilates. Proficient in designing impactful
              ...
              <div className="mb-6">
                ...
                <ul className="text-gray-700 text-sm space-y-1.5">
                  <li>• Y.I.C (Yoga Instructor Course) from SVYASA Deemed University</li>
                  <li>• Completed Level 1 - Yoga Instructor by The Yoga Certification Board</li>
                  <li>• Completed Kapila Yoga Teacher Training Diploma Course,Hyderabad</li>
                  <li>• Certified for 500-hour Master Yoga Teacher Training from Yoga Alliance International</li>
                  <li>• MSc in Yoga Therapy from Swami Vivekananda Yoga Anusandhana Samathana University (SVYASA)</li>
                  <li>• Certified for Pilates on Mat - Level 1 from Zone Education Program</li>
                  <li>• Certified Mat Pilates Teacher Training from Aatmya Yoga School</li>
                  <li>• Completed course in Power Yoga from Swarna Kamal Yoga Centre</li>
                  <li>• BSc in Computer Science, Mathematics, Electronics</li>
                  <li>• Post Graduate Diploma in Computer Application from Bhopal University (M.P)</li>
                  <li>• Winner of National Level Open Yoga Championship 2017</li>
                </ul>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  Vinyasa yoga, Ashtanga yoga, Therapeu6c prac6ces for Rehabilita6on,
Strength training with and without weights, Weight loss program,
Pilates
                </p>
              </div>
