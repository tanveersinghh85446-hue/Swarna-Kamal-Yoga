...
//   // Stats visibility for counter trigger
...
//   // Scroll to top button + smooth scroll for mobile
//   useEffect(() => {
//     // Smooth scroll globally (for mobile)
...
//                 <Link
//                   to={s.to}
//                   className="bg-amber-500 hover:bg-amber-600 text-white font-bold px-8 py-3 rounded-full transition-all duration-300 shadow-lg hover:-translate-y-0.5 transform"
//                 >
//                   {s.btn}
//                 </Link>
//                 <Link
...
//       {/* ── 2. STATS BAR (Auto Count) ── */}
//       <div ref={statsRef} className="bg-amber-500 py-6 sm:py-8">
...
//             <div className="img-zoom w-72 h-96 sm:w-80 rounded-2xl overflow-hidden shadow-2xl border-4 border-amber-100">
//               <img
//                 src="Samita4.jpeg"
//                 alt="Yoga"
//                 className="w-full h-full object-cover"
...
//                     <h3 className="text-base font-bold text-gray-800 group-hover:text-amber-700 transition-colors mb-2">
//                       {item.title}
//                     </h3>
//                     <p className="text-gray-500 text-sm leading-relaxed">
//                       {item.desc}
...
//                 <div
//                   key={i}
//                   className="bg-white/20 border border-white/30 rounded-xl px-5 py-2.5 font-medium text-sm hover:bg-white/30 transition-all"
//                 >
//                   {tag}
//                 </div>
//               ))}
...
//               <Link
//                 to="/apply"
//                 className="bg-white text-amber-600 font-extrabold px-8 py-3 rounded-full hover:bg-amber-50 transition-all shadow-lg hover:-translate-y-0.5 transform inline-block"
//               >
//                 Start Your Journey →
//               </Link>
//             </div>
...
//                 target="_blank"
//                 rel="noreferrer"
//                 className="inline-flex items-center justify-center gap-3 bg-green-500 hover:bg-green-600 text-white font-bold px-8 py-4 rounded-full transition-all shadow-lg hover:-translate-y-0.5 transform text-base"
//               >
...
//           className="bounce-up fixed bottom-6 right-6 z-50 w-12 h-12 bg-red-500 hover:bg-blue-600 text-white rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 transform text-xl font-bold"
//         >
//           ↑
//         </button>
//       )}
